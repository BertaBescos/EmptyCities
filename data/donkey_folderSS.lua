...
local preprocessAandBandC = function(imA, imB, imC)
  ...
  imC = image.scale(imC, loadSize[2], loadSize[2],'simple')
...
local CARLAtoCityscapes = function(imC)
    _imC = imC:clone()
    _imC[imC:eq(0)] = 1 --None
    _imC[imC:eq(1)] = 4 --Buildings
    _imC[imC:eq(2)] = 6 --Fences
    _imC[imC:eq(3)] = 1 --Other
    _imC[imC:eq(4)] = 13 --Person
    _imC[imC:eq(5)] = 7 --Pole
    _imC[imC:eq(6)] = 1 --Roadline
    _imC[imC:eq(7)] = 2 --Roads
    _imC[imC:eq(8)] = 3 --Sidewalks
    _imC[imC:eq(9)] = 10 --Vegetation
    _imC[imC:eq(10)] = 15 --Car
    _imC[imC:eq(11)] = 5 --Walls
    _imC[imC:eq(12)] = 9 --TrafficSigns
    return _imC
end
...
local function loadImage(path)
   ...
   local imC = image.crop(input_mask, 2*w/3, 0, w, h)
